...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		...
		String[] arrOfPatterns = new String[ServiceContainerEnum.values().length];
		int i = 0;
		for (ServiceContainerEnum service : ServiceContainerEnum.values()) {
			arrOfPatterns[i++] = MessageFormat.format("/{0}/secure/**", service.getContextPath());
		}
